...
export const de = {
  ...
  settings: {
    ...
    dialog: {
      title: "Einstellungen",
      description: "Verwalten Sie Ihre EquateX-Einstellungen.",
    ...
    general: {
      title: "Allgemein",
      description: "Globale Einstellungen für EquateX.",
      account: "Konto",
      ...
      password: "Passwort",
      passwordDescription:
        "Ändern Sie das Passwort für dieses EquateX-Konto.",
      passwordDialog: {
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Löscht nur lokal gespeicherte Einstellungen und lädt EquateX neu. Chats, API-Zugriff und in der DB gespeicherte Einstellungen bleiben erhalten.",
        confirmAction: "Zurücksetzen und neu laden",
      },
    },
    profile: {
      title: "Profil",
      description: "Wie Ihr Profil in EquateX angezeigt wird.",
      changePicture: "Profilbild ändern",
      displayName: "Anzeigename",
      nickname: "Wie soll EquateX Sie nennen?",
    ...
    appearance: {
      title: "Darstellung",
      description: "Wie EquateX Studio auf diesem Gerät aussieht.",
      theme: {
        title: "Design",
        label: "Farbschema",
      ...
      language: {
        ...
        description: "Die von EquateX verwendete Sprache.",
    ...
    resources: {
      title: "System",
      description:
        "Überwachen Sie Hardware und Speicher dieses EquateX-Servers.",
    ...
    apiKeys: {
      title: "API",
      description: "Zugriff auf EquateX über die OpenAI-kompatible API.",
      ...
      secureHttpsHint:
        "Der 0.0.0.0-Port ist weiterhin global erreichbar. Für vollständige Sicherheit starten Sie EquateX Studio mit --secure, um nur diesen HTTPS-Link freizugeben.",
    ...
    about: {
      ...
      shutDownStudio: "EquateX Studio herunterfahren",
      shutDownStudioDescription:
        "Stoppt den EquateX-Server und beendet Ihre Sitzung.",
      shutDown: "Herunterfahren",
      update: {
        title: "EquateX Studio aktualisieren",
        commandText: "{label}-Text",
        copied: "Kopiert",
        copyCommand: "Befehl kopieren",
        commandCopied: "{label} kopiert",
        copyNamedCommand: "{label} kopieren",
        checkingInstall: "Prüfe, wie EquateX installiert wurde...",
        installIntro: "So installieren oder aktualisieren Sie EquateX:",
        ...
        restartAfterUpdate: "Starten Sie EquateX nach dem Update neu.",
        desktopManaged:
          "Die Desktop-App hält ihr gebündeltes Backend aktuell und weist auf neue Versionen hin, sobald sie verfügbar sind.",
        unknownInstall:
          "Es konnte nicht erkannt werden, wie EquateX installiert wurde. Verwenden Sie für Installer- oder PyPI-Installationen die obigen Befehle.",
        localCheckout:
  ...
  studio: {
    ...
    trainingStart: {
      ...
      terminalStart: "> EquateX-Training beginnt...",
