...
export const ja = {
  ...
  settings: {
    ...
    dialog: {
      title: "設定",
      description: "EquateX の環境設定を管理します。",
    ...
    general: {
      ...
      password: "パスワード",
      passwordDescription: "この EquateX アカウントのパスワードを変更します。",
      passwordDialog: {
        trigger: "パスワード変更",
        title: "パスワード変更",
      ...
      resetPreferences: {
        ...
        confirmDescription: "ローカル限定の設定を消去し、EquateX を再読み込みします。チャット、APIアクセス、DBに保存された設定は保持されます。",
        confirmAction: "リセットして再読み込み",
      },
    },
    profile: {
      title: "プロフィール",
      description: "EquateX 内でのプロフィールの表示方法。",
      changePicture: "プロフィール写真を変更",
      displayName: "表示名",
      nickname: "EquateX での呼び名",
    ...
    appearance: {
      title: "外観",
      description: "このデバイスでの EquateX Studio の見た目。",
      theme: {
        title: "テーマ",
        label: "カラー構成",
      ...
      palette: {
        label: "カラーパレット",
        description: "EquateX 全体で使用される配色。ライト・ダーク両対応。",
        standard: "スタンダード",
        classic: "クラシック",
        minimal: "ミニマル",
      },
      custom: {
        ...
        uiFontSize: {
          label: "UI フォントサイズ",
          description: "EquateX UI の基本サイズを調整します。",
        },
        codeFontSize: {
          label: "コードフォントサイズ",
    ...
    resources: {
      title: "システム",
      description: "この EquateX サーバーのハードウェアとストレージを監視します。",
    ...
    apiKeys: {
      title: "API",
      description: "OpenAI互換 API を介して EquateX にアクセスします。",
      ...
      secureHttpsHint: "0.0.0.0 ポートは依然としてグローバルにアクセス可能です。完全なセキュリティを確保するには、EquateX Studio を --secure 付きで起動し、この HTTPS リンクのみを公開してください。",
    ...
    about: {
      ...
      dangerZone: "危険ゾーン",
      shutDownStudio: "EquateX Studio をシャットダウン",
      shutDownStudioDescription: "EquateX サーバーを停止し、セッションを終了します。",
      shutDown: "シャットダウン",
      update: {
        title: "EquateX Studio のアップデート",
        commandText: "{label} テキスト",
        copied: "コピーしました",
        copyCommand: "コマンドをコピー",
        commandCopied: "{label} をコピーしました",
        copyNamedCommand: "{label} をコピー",
        checkingInstall: "EquateX がどのようにインストールされたかを確認中...",
        installIntro: "EquateX のインストールまたはアップデート方法:",
        ...
        restartAfterUpdate: "アップデート後に EquateX を再起動してください。",
        desktopManaged: "デスクトップアプリは同梱されているバックエンドを自動的に最新に保ち、新しいバージョンが利用可能になると通知します。",
        unknownInstall: "EquateX がどのようにインストールされたか検出できませんでした。インストーラーまたは PyPI インストールの場合は、上記のコマンドを使用してください。",
